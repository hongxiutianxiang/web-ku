		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<img src="../../assets/images/bizhia.jpg" alt="">
				</div>
				<div class="swiper-slide">
					<img src="../../assets/images/bizhib.jpg" alt="">
				</div>
				<div class="swiper-slide">
					<img src="../../assets/images/bizhic.jpg" alt="">
				</div>
			</div>
			<!-- 如果需要分页器 -->
...
<script>
	...
	import { GET_HOME_PRODUCTS } from '../../store/types.js'
